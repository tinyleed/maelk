...
Mælk is an early-stage public project for a commerce/business operating system. Please treat security, privacy, credentials, and live operational data as human-gated areas.
...
- production data, customer/supplier private data, or internal account details;
...
Human approval remains required for production, deploy, go-live, compliance, pricing, and release decisions.
